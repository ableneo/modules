...
describe("default config", () => {
  describe("no-errors", () => {
    it("should match snapshot [js]", () => {
      const report = runFixture("prettier/fix-no-errors", {fix: true});
    ...
    it("should match snapshot [tsx]", () => {
      const report = runFixture("prettier/fix-no-errors-tsx", {fix: true});
      const result = report.results[0];
    ...
    it("should have no errors or warnings", () => {
      const report = runFixture("prettier", {fix: true});
